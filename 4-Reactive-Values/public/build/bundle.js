...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t8 = space();
    			img = element("img");
    			attr_dev(h1, "class", "svelte-1o8knhv");
    			add_location(h1, file, 14, 1, 198);
    			attr_dev(label0, "for", "firstname");
    			add_location(label0, file, 16, 1, 226);
    			attr_dev(input0, "type", "text");
    			add_location(input0, file, 17, 1, 268);
    			attr_dev(label1, "for", "firstname");
    			add_location(label1, file, 18, 1, 312);
    			attr_dev(input1, "type", "text");
    			add_location(input1, file, 19, 1, 353);
    			if (img.src !== (img_src_value = /*src*/ ctx[3])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Svelte logo");
    			add_location(img, file, 22, 1, 399);
    			attr_dev(main, "class", "svelte-1o8knhv");
    			add_location(main, file, 13, 0, 190);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*fullName*/ 4) set_data_dev(t1, /*fullName*/ ctx[2]);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ firstName, lastName, src, fullName });
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*lastName, firstName*/ 3) {
    			 {
    	...
    	return [firstName, lastName, fullName, src, input0_input_handler, input1_input_handler];
    }
